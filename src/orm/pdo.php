...
//                return  ['error' => $e->getMessage()];
    ...
    public static function getcounts($joinStr =  "", $whereStr, $tablename) {
        try{
    ...
    public static  function getdata($offset = 0,$limit = 10,$field = "", $joinStr =  "", $whereStr =  "1 = 1", $tablename = 'account_ad' , $key='id'):array | null
    {
        $client = self::createclient();
        ...
        $sql .= "  WHERE {$whereStr} ORDER BY `{$key}` DESC LIMIT  :start , :num  ";
        self::setSql( $sql  );
